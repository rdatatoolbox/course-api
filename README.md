## :mortar_board: API and Webscraping with R <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/R_logo.svg/724px-R_logo.svg.png" height="120" align="right"/>

[![License: CC
BY 4.0](https://img.shields.io/badge/License-CC%20BY%204.0-lightgreen.svg)](https://choosealicense.com/licenses/cc-by-4.0/)


Code used to create the online presentation **API and Webscraping with R** available at:
[**rdatatoolbox.github.io/course-api**](https://rdatatoolbox.github.io/course-api)
...
[`DESCRIPTION`](https://github.com/rdatatoolbox/course-api/blob/main/DESCRIPTION)
file.
...
[`index.Rmd`](https://github.com/rdatatoolbox/course-api/blob/main/index.Rmd) 
